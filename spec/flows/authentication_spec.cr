...
# NOTE: LuckyFlow specs are skipped as of Lucky v1.4.0
# This is due to race conditions in LuckyFlow.
# Ref: https://github.com/luckyframework/lucky_cli/issues/883
# See spec/requests/authentication_spec.cr for working request-based authentication tests
describe "Authentication flow", tags: "flow" do
  pending "works (skipped - use spec/requests/authentication_spec.cr instead)" do
  ...
  pending "allows sign in through backdoor when testing (skipped - use request specs)" do
